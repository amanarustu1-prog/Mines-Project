...
const FuelTypeIcon = ({ className }: { className?: string }) => (
                                ...
                                <div className="list-compact-form">
                                    <div className="list-compact-grid grid grid-cols-2 gap-2">
                                        <input
                                            ...
                                            placeholder="Fuel Type Code (e.g., FT001)"
                                            maxLength={20}
                                        />
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <FuelTypeIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">Fuel Type Master</h1>
                            <p className="list-header-subtitle">Master data with codes and descriptions for fuel types</p>
                        </div>
                    </div>
                </div>
            </div>
