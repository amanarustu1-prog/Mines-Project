      ...
      <main className="dashboard-main ">
        <div className="main-content-area ">
          <div className="main-content-wrapper mt-5 ">
            {/* Header */}
            <div className="pending-challan-header-info d-flex align-items-center  employee-master-card p-2 margin_top">
              {/* Icon */}
              <div className="pending-challan-header-icon me-3">
            ...
            <div className="employee-master-space-y-2">
              {/* Employee List Table */}
              <div className="employee-master-card  mt-3">
