        ...
        setChallanData({
            ...
            productDetails: [
                ...(record.ProductId1 ? [{
                    ...
                    ChallanDate: moment(record.Grossweightdate1).format('YYYY-MM-DD HH:mm:ss')
                }] : []),
                ...(record.ProductId2 ? [{
                    ...
                    ChallanDate: moment(record.Grossweightdate2).format('YYYY-MM-DD HH:mm:ss')
                }] : []),
                ...(record.ProductId3 ? [{
                    ...
                    ChallanDate: moment(record.Grossweightdate3).format('YYYY-MM-DD HH:mm:ss')
                }] : []),
            ],

            weightDetails: {
                tareWeight: Number(record.TareWeight) || 0,
                ChallanDate: moment(record.Taredate || record.Grossdate).format('YYYY-MM-DD HH:mm:ss'),
                                            ...
                                            <div className="col-xl-3 mt-3 mt-xl-0">
                                                <div className="d-flex align-items-center gap-2">
                                                    ...
                                                    <div className="product-des-input flex-grow-1">
                                                        <DatePicker
                                                          selected={moment(challanData.ChallanDate, "YYYY-MM-DD HH:mm:ss").toDate()} 
