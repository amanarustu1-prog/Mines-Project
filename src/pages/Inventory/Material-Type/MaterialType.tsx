...
const MaterialTypeIcon = ({ className }: { className?: string }) => (
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <MaterialTypeIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">Material Type</h1>
                            <p className="list-header-subtitle">Master data with codes and descriptions for material types</p>
                        </div>
                    </div>
                </div>
            </div>
