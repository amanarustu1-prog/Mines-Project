...
const MaterialType: React.FC<Props> = ({ baseUrl = '', companyId = null }) => {
    ...
    const handleSaveMaterialType = async () => {
        ...
        if (editItemId) {
            const success = await updateMaterialType(maintenanceTypeForm, editItemId);
            if (success) {
                setShowMaintenanceTypeModal(false);
                setEditItemId(null);
                resetForm();
            ...
            const success = await insertMaterialType(maintenanceTypeForm);
            if (success) {
                setShowMaintenanceTypeModal(false);
                resetForm();
            }
                ...
                <div className="maintenance-type-main">
                    ...
                    <div className="maintenance-type-tabs">
                        <div className="maintenance-type-tabs-container">
                            <div className="maintenance-type-grid maintenance-type-grid-cols-1 maintenance-type-grid-box material-type-md-grid-cols-4 maintenance-type-gap-6 py-3 px-2">
