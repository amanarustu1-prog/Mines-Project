...
const IDProofIcon = ({ className }: { className?: string }) => (
                                ...
                                <div className="list-compact-form">
                                    <div className="list-compact-grid grid grid-cols-2 gap-2">
                                        <input
                                            ...
                                            placeholder="ID Proof Code (e.g., IDP001)"
                                            maxLength={20}
                                        />
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <IDProofIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">ID Proof</h1>
                            <p className="list-header-subtitle">Manage ID proofs with codes and descriptions</p>
                        </div>
                    </div>
