...
import './LeaveTypeMaster.css';
import { List } from 'lucide-react';

// Icon components (simplified SVG icons)
const LeaveTypeMasterIcon = ({ className }: { className?: string }) => (
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <LeaveTypeMasterIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">Leave Type Master</h1>
                            <p className="list-header-subtitle">Manage leave types with codes and descriptions</p>
                        </div>
                    </div>
