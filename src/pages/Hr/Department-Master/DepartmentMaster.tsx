...
const DepartmentMasterIcon = ({ className }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h-2m-2 0h-5m-9 0H3m5 0h14M9 7h1" />
    </svg>
);
...
export default function DepartmentMaster() {
    ...
    const tabs = [
        { id: 'list-overview', label: 'List Overview', icon: DepartmentMasterIcon }
    ];
                ...
                return (
                    <div className="list-space-y-4">
                        ...
                        <div className="list-card compact">
                            <div className="list-card-content py-2">
                                <div className="list-compact-form">
                                    <div className="list-compact-grid grid grid-cols-2 gap-2">
                                        <input
                                            ...
                                            placeholder="Department Code (e.g., DEPT001)"
                                            maxLength={20}
                                        />
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <DepartmentMasterIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">Department Master</h1>
                            <p className="list-header-subtitle">Manage Department Master with codes and descriptions</p>
                        </div>
                    </div>
