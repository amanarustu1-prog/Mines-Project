...
const MaritialStatusIcon = ({ className }: { className?: string }) => (
...
export default function MaritialStatus() {
                ...
                <div className="list-header-content container">
                    <div className="list-header-info">
                        <div className="list-header-icon">
                            <MaritialStatusIcon className="list-icon-sm" />
                        </div>
                        <div>
                            <h1 className="list-header-title">Maritial Status</h1>
                            <p className="list-header-subtitle">Manage Maritial Status with codes and descriptions</p>
                        </div>
                    </div>
