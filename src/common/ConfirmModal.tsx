...
const ConfirmModal: React.FC<ConfirmModalProps> = ({ show, handleClose, handleConfirm }) => {
    ...
    return (
        <div className="modal d-block" style={{ background: "rgba(0, 0, 0, 0.5)", zIndex: 11111, }} tabIndex={-1} role="dialog" ria-hidden={!show} id="SaveModal" data-backdrop="false" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
